...
# blueprint items
bp=['Dakra Prime Blade','Vauban Prime System','Tigris Prime Blueprint','Nekros Prime Blueprint','Nekros Prime System','Valkyr Prime Chassis','Valkyr Prime System','Banshee Prime System','Reaper Prime Blade','Soma Prime Stock','Dual Kamas Prime Blade','Galatine Prime Blueprint']
# Set items
st=['Dakra Prime Set','Mag Prime Set','Nova Prime Set','Nyx Prime Set','Scindo Prime Set','Reaper Prime Set','Soma Prime Set']
# Mod items
md=['Vengeful Revenant','Sovereign Outcast','Empowered Blades','Growing Power','Enduring Affliction']
